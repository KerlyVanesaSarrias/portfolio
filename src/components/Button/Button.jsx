...
const Button = ({ color, size, children, onClick, isOnlyIcon = false, className }) => {
    const buttonClasses = classNames( {
        ...
        'w-48 h-10 2xl:w-52 2xl:h-12 2xl:text-xl px-5 font-medium ': size === 'small',
        'w-full h-12 px-4 py-2 font-semibold': size === 'medium',
        '!rounded-full h-10 w-10 2xl:w-12 2xl:h-12 2xl:text-2xl text-xl flex justify-center items-center border-2 border-gray-400 dark:border-white': isOnlyIcon
    }, className);
