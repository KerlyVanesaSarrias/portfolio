...
const InfContact = () => {
    ...
    <div >
        <div className=' dark-text gap-10 w-96'>
            <h3 className='brand'>CONTACT INFORMATION</h3>
            <address>
                <div className='mb-5'>
                    <span className='flex gap-4'>
                        <FaWhatsapp className='text-4xl text-cyan-500'/>  
                ...
                <div className='mb-5'>
                    <span className='flex gap-4'>   
                        <MdOutlinePhoneAndroid className='text-4xl text-cyan-500'/>
                        <a href="tel:1-234-567-8910"> +57 3143046748 </a>
                    </span>
                </div>
                <div className='mb-5'>
                    <span className='flex gap-4'>
                        <MdOutlineMail className='text-4xl text-cyan-500'/>
                        <a id="mail" href="mailto:test@correo.com"> kerlysarrias011@gmail.com </a>
                    </span>
                </div>
                <div className='flex gap-4'>
                    <MdOutlineLocationOn className='text-4xl text-cyan-500'/>
