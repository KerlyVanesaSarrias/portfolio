...
const Header = () => {
  ...
  return (
    <>
    <div className='w-full md:py-6 py-4 px-2 md:px-4 dark-text flex justify-between  items-center sticky top-0  bg-gradient-to-b dark:from-[#31475f] from-[#6d96a1] backdrop-blur-sm transition-colors duration-300 z-10'>
      <div className='flex items-center cursor-pointer gap-3' onClick={() => handleChangePage(HOME_PATH)}  >
        <img className='md:h-16 md:w-16 w-9 h-9 ' src={LogoOne} alt="" />
        <p className='md:text-2xl text-sm font-light space-x-10'> KERLY</p>
      </div>
      <div className='flex gap-2 md:gap-4'>
        <nav className='font-light 2xl:text-xl cursor-pointer hidden md:flex space-x-6 2xl:space-x-12'>
