...
const Header = () => {
  ...
  return (
    <div className=' w-full py-2 px-8 flex justify-between items-center bg-[#25142D]'>
      <ul className='flex items-center'>
        <li><img className='h-20 w-15 mr-2' src="/src/assets/logo2.png" alt="" /></li>
        <li><a className='text-xl font-extrabold bg-gradient-to-r from-red-500  to-fuchsia-950 inline-block text-transparent bg-clip-text'> KERLY</a></li>
      </ul>
      
      <nav className='flex items-center space-x-10  text-white cursor-pointer'>
